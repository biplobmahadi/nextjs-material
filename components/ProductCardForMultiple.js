...
export default function ProductCard({ product, myBag, config, changeMyBag, urlForChangeCardProducts, changeCardProducts }) {
                        ...
                        .then((res) => {
                            ...
                            axios
                                ...
                                .then((res) => {
                                    ...
                                    axios
                                        .get(urlForChangeCardProducts)
                                        .then((res) => {
                                            changeCardProducts(res.data)
                                            axios
                                                .get(
                                                    `http://localhost:8000/my-bag/${myBag.id}/`,
                                                    config
